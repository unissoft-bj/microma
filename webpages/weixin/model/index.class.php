...
class index_controller extends common
{
	...
	private function getToken()
	{
		...
		{	
			...
			$this->obj->made_web(PLUS_PATH."config.php",$this->ArrayToString($this->config),"config");
	...
	public function creat_action()
	{
		...
		$Token = $this->getToken();
		$AutoNav = '{"button":[
			{"name":"我的菜单","sub_button":[
				{"type":"click","name":"我的帐号","key":"我的帐号"},
				{"type":"click","name":"我的消息","key":"我的消息"},
				{"type":"click","name":"面试邀请","key":"面试邀请"},
				{"type":"click","name":"简历查看","key":"简历查看"},
				{"type":"click","name":"刷新简历","key":"刷新简历"}]},
			{"name":"找工作","sub_button":[
				{"type":"click","name":"职位搜索","key":"职位搜索"},
				{"type":"click","name":"周边职位","key":"周边职位"},
				{"type":"click","name":"推荐职位","key":"推荐职位"}]},
			{"name":"更多功能","sub_button":[
				{"type":"click","name":"每日签到","key":"每日签到"},
				{"type":"click","name":"职场资讯","key":"职场资讯"},
				{"type":"click","name":"互动问答","key":"互动问答"}]}
			]}';
		
		$Url = "https://api.weixin.qq.com/cgi-bin/menu/create?access_token=".$Token;
		$result = CurlPost($Url,$AutoNav);
	}
