		...
		if( $kid && $type ){
			...
			if(is_array($adcity)){
				foreach($adcity as $key=>$value){
					...
					$html.="<td class=\"ud\"><input class=\"subbut\" onclick=\"checkedtr('".$value['id']."');\" type=\"button\" name=\"update\" value=\"更新\" /> | <a href=\"javascript:;\"><img src=\"images/iconv/del_icon2.gif\" onclick=\"delsingle('".$value['id']."','2');\" alt=\"删除\" title=\"删除\"/></a></td>";
					$html.="</select> </td>";
					$html.="</tr>";
				}
			}
