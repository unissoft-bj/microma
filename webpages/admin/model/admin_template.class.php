...
class admin_template_controller extends common
{
	...
	function tpadd_action()
	{
		$path = APP_PATH."/template/".$this->config['style']."/";
		$this->yunset("style",$this->config['style']."/");
		$this->yunset("path",$path);
		$this->yuntpl(array('admin/admin_tpadd'));
