...
$arr_data = array (
	...
	'datacall' => array(
		...
		'keyword'=>array("热门关键字","order"=>array("num desc"=>"搜索次数"),"field"=>array("name"=>"关键字名称","url"=>"链接","num"=>"搜索次数"),"where"=>array("keytype"=>array("0"=>"关键字类型","1"=>"一句话招聘","3"=>"职位","4"=>"公司","5"=>"简历")))
	),
	'seoconfig'=>array(
		'公共参数'=>array(
			'webname'=>"网站名称",
