      ...
      // $db->q($sql);
       if (! empty($v_sid)) {
     		 // 	echo "1111111";
	       	...
	       	$i=1;
	       	foreach ($rst as $k=>$rs){
			       	 echo "<div class=\"clearfix\">\r\n<p class=\"result_tit\"><span>".$i.".</span>".$rs[ttitle]."</p><div class=\"result_con\">\r\n"	;
			       	 //echo "====你好".$rs[listtype]."====";
			       	 ...
			       	 //echo $sql;
					       	 ...
					       	 foreach ($rsq as $k=>$rs1){
					       	 	echo "<p class=\"clearfix\"><span class=\"left\">{$rs1[question]}</span><span class=\"right\">{$rs1[count]}票</span></p>";
