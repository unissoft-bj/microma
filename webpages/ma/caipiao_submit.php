  ...
  <form action="" method="post" >
   ...
   //$sql="select integral from useraccounts where userid='".$_COOKIE['userid']."'";
    ...
    <p>
      ...
      <input name="username" id="username" type="text"class="input-common placeholder" placeholder="用户名" value=""/>
    </p>
    <p>
      <input name="email" id="email" type="text"class="input-common placeholder" placeholder="email" value=""/>
    </p>
    <p>
      <input name="cid" id="cid" type="text"class="input-common placeholder" placeholder="身份证号"  value=""/>
    </p>
