...
{
    var status="http://" + get_param("uamip") + ":" + get_param("uamport") + "/status";
    var w = window.open(status, "smallwin", 
...
{
    document.write('<a href="http://' + get_param('uamip') + ':' + 
                   get_param('uamport') + '/logout">Logout</a>');
}
