...
?>
		...
		<div id="bottom_bar" style="display: none">
				...
				<div id="bottom_bar_content" class="buttons">
						 
						<a id="bottom_bar_save_form" href="#" class="positive" style="font-weight: bold" alt="Save Form" title="Save Form">
					        <img src="images/icons/tick.png" alt=""/>
					        Save Form
					    </a>
					    
					    <a id="bottom_bar_add_field" class="positive" href="#" alt="Add a New Field" title="Add a New Field">
