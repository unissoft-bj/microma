 ...
 ********************************************************************************/
	...
	function mf_set_language($target_language){
		...
		if($target_language == 'english'){
			...
			$languages['captcha_text_mismatch'] 		= 'Nespráva odpoveï. Skúste prosím ešte raz.';
			...
			//form buttons
			$languages['submit_button']			=	'Odosla';
			$languages['continue_button']		=	'Pokraèova';
			$languages['back_button']			=	'Naspä';
			
			//form status
			$languages['form_inactive']			=	'Tento formulár momentálne nie je aktívny.';
			$languages['form_limited']			=   'Prepáète, tento formulár momentálne už neprijíma vstupné údaje.';
			...
			$languages['review_message']		=	'Skontrolujte si vložené údaje a stlaète Odosla.';
			...
			$languages['val_integer'] 			=	'Toto pole musí by celé èíslo.';
			$languages['val_float'] 			=	'Toto pole musí by reálne èíslo.';
			$languages['val_numeric'] 			=	'Toto pole musí by èíslo.';
			$languages['val_email'] 			=	'Nesprávny formát emailu.';
			$languages['val_website'] 			=	'Nesprávny formát web adresy.';
			$languages['val_username'] 			=	'Toto pole môže obsahova iba a-z 0-9 a podèiarkovník.';
			$languages['val_equal'] 			=	'%s musí pasova.';
			$languages['val_date'] 				=	'Nesprávny formát dátumu.';
			$languages['val_date_range'] 		=	'Toto dátumové pole musí by medzi %s a %s.';
			$languages['val_date_min'] 			=	'Toto dátumové pole musí by väèšie alebo rovné %s.';
			$languages['val_date_max'] 			=	'Toto dátumové pole musí menšie alebo rovné %s.';
			$languages['val_date_na'] 			=	'Tento dátum nie je možné vybra.';
			$languages['val_time'] 				=	'Toto pole nemá správny formát èasu.';
			$languages['val_phone'] 			=	'Prosím vložte platné telefónne èíslo.';
			$languages['val_filetype']			=	'Tento typ súboru nie je povolený.';
			
			//fields on excel/csv
			$languages['export_num']			=	'È.';
			...
			$languages['resume_email_content'] 		= 'Ïakujeme! Váš príspevok k <b>%s</b> bol uložený.<br /><br />You can resume the form at any time by clicking the link below:<br /><a href="%s">%s</a><br /><br /><br /><br /><b>IMPORTANT:</b><br />Váš príspevok je považovaný za neplatný, kým znovu nenaèítate formulár a nestlaèíte tlaèítko Odosla.';							

			$languages['resume_success_title']   	= 'Aktuálny stav bol uložený.';
			$languages['resume_success_content'] 	= 'Prosím skopírujte uvedený odkaz a uložte ho na bezpeèné miesto:<br/>%s<br/><br/>Vo vypåòaní môžete kedyko¾vek pokraèova, keï kliknete na odkaz.';

			$languages['resume_checkbox_title']		= 'Uloži aktuálny stav a pokraèova neskôr';
			$languages['resume_email_input_label']	= 'Vložte Váš Email';
			$languages['resume_submit_button_text']	= 'Uloži formulár a pokraèova neskôr';
			$languages['resume_guideline']			= 'Na Váš email bude odoslaný špeciálny odkaz, ktorý Vám umožní pokraèova vo vypåòaní formulára.';

			//range validation
			$languages['range_type_digit']			= 'èíslic';
			...
			$languages['range_min_max'] 			= 'Musí to by medzi %s a %s.';
			$languages['range_min_max_same'] 		= 'Musí byť %s.';
			$languages['range_min_max_entered'] 	= 'Aktuálne vložených: %s.';

			$languages['range_number_min']	 		= 'Musí to by èíslo väèšie alebo rovné %s.';
			$languages['range_number_max']	 		= 'Musí to by èíslo menšie alebo rovné %s.';
			$languages['range_number_min_max'] 		= 'Musí to by èíslo medzi %s a %s';

			//file uploads
			$languages['file_queue_limited'] 		= 'Toto pole je obmedzené na maximálne %s súborov.';
			$languages['file_upload_max']	   		= 'Chyba. Maximálna ve¾kos súboru je %s MB.';
			$languages['file_type_limited']  		= 'Chyba. Tento typ súboru nie je povolený.';
			$languages['file_error_upload']  		= 'Chyba! Upload sa nepodaril.';
			$languages['file_attach']		  		= 'Pripoji súbory';
			...
			$languages['payment_submit_button']		= 'Odosla platbu';
			$languages['tax']						= 'Tax';
			...
			$languages['payment_billing']	 = 'Fakturaèná adresa';		
