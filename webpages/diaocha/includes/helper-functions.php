    		...
    		$message_div = <<<EOT
    		    <div class="gradient_blue content_notification">
					...
					<div class="cn_message">
						<h6 style="font-weight: 700;font-size: 16px">Success!</h6>
...
EOT;
    ...
    function mf_send_notification($dbh,$form_id,$entry_id,$to_emails,$email_param){
    	...
    	if($target_is_admin === false){
    		$options['strip_download_link'] = false; //as of v3, receipt email should display download link
    	}

    	$options['strip_checkbox_image'] = true;
    	$options['machform_path'] = $email_param['machform_base_path']; //the path to machform
