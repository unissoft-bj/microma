				...
				<div class="content_body">
					...
					<div id="ve_actions">
						<div id="ve_entry_navigation">
							<a href="<?php echo "view_user.php?id={$user_id}&nav=prev"; ?>" title="Previous User"><img src="images/icons/16_left.png" /></a>
							<a href="<?php echo "view_user.php?id={$user_id}&nav=next"; ?>" title="Next User" style="margin-left: 5px"><img src="images/icons/16_right.png" /></a>
						</div>
						...
						<div id="ve_entry_actions" class="gradient_blue">
							<ul>
								<li style="border-bottom: 1px dashed #8EACCF"><a id="vu_action_edit" title="Edit User" href="<?php echo "edit_user.php?id={$user_id}"; ?>">Edit</a></li>
								<li style="border-bottom: 1px dashed #8EACCF"><a id="vu_action_password" title="Change Password" href="#">Password</a></li>
								<?php if($user_id != 1){ ?>
								<?php
									if($is_user_suspended){
										echo '<li style="border-bottom: 1px dashed #8EACCF"><a id="vu_action_suspend" class="unsuspend" title="Un-Suspend User" href="#">Unblock</a></li>';
									}else{
										echo '<li style="border-bottom: 1px dashed #8EACCF"><a id="vu_action_suspend" title="Suspend User" href="#">Suspend</a></li>';
									}
								?>
								<li><a id="vu_action_delete" title="Delete User" href="#">Delete</a></li>
								<?php } ?>
							</ul>
						</div>
						<?php } ?>
