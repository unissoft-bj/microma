 ...
 ********************************************************************************/	
	...
	$query = "select element_name from ".MF_TABLE_PREFIX."column_preferences where form_id=? and user_id=?";
	$params = array($form_id,$_SESSION['mf_user_id']);
					...
					<?php if($form_has_entries){ ?>
						...
						<div id="entries_actions" class="gradient_red">
							<ul>
								...
								<li>
									<a id="entry_delete" href="#">Delete</a>
								</li>
								<?php } ?>
								...
								<li>
									<a id="entry_export" href="#">Export</a>
								</li>
							</ul>
						...
						<div id="entries_options" class="gradient_blue" data-formid="<?php echo $form_id; ?>">
							<ul>
								<li>
									<a id="entry_select_field" href="#">Select Fields</a>
								</li>
								<li>
									<div style="border-left: 1px dotted #3B699F;height: 35px;margin-top:5px"></div>
								</li>
								<li>
									<a id="entry_filter" href="#">Filter Entries</a>
								</li>
							</ul>
						</div>
						...
						<div id="field_selection" style="display: none" class="gradient_blue">
							...
							<div id="field_selection_apply">
									<input type="button" id="me_field_select_submit" value="Apply" class="button_text"> <span id="cancel_field_select_span">or <a href="#" id="field_selection_cancel">Cancel</a></span>
							</div>
						...
						<div id="filter_pane" style="display: none" class="gradient_blue">
							...
							<div id="filter_pane_apply">
									<input type="button" id="me_filter_pane_submit" value="Apply Filter" class="button_text"> <span id="cancel_filter_pane_span">or <a href="#" id="filter_pane_cancel">Cancel</a></span>
							</div>
