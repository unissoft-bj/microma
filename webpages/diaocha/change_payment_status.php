 ...
 ********************************************************************************/
	...
	if(!empty($row['record_exist'])){
		...
		$form_properties = mf_get_form_properties($dbh,$form_id,array('payment_merchant_type','payment_price_type','payment_price_amount','payment_currency','payment_enable_tax','payment_tax_rate'));
