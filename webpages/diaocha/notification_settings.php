				...
				<div class="content_header">
					<div class="content_header_title">
						<div style="float: left">
							<h2><?php echo "<a class=\"breadcrumb\" href='manage_forms.php?id={$form_id}'>".$form_name.'</a>'; ?> <img src="images/icons/resultset_next.gif" /> Email Settings</h2>
							<p>Configure email notification options for your form</p>
						</div>	
						...
						<li>
							<div id="ns_box_myinbox" class="ns_box_main gradient_blue">
								<div class="ns_box_title">
									<input type="checkbox" value="1" class="checkbox" id="esl_enable" name="esl_enable" <?php if(!empty($esl_enable) || (empty($esl_enable) && empty($form_email))){ echo 'checked="checked"';} ?>>
								...
								<div class="ns_box_email" <?php if(empty($esl_enable) && !empty($form_email)){ echo 'style="display: none"'; } ?>>
