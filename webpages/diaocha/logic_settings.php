									...
									<ul id="ls_email_rules_group">
										<?php
											foreach ($logic_emails_array as $rule_id => $value) {
												...
												$rule_properties->target_email 		= $value['target_email'];
												$rule_properties->template_name 	= $value['template_name'];
												$rule_properties->custom_from_name 	= $value['custom_from_name'];
												$rule_properties->custom_from_email = $value['custom_from_email'];
												$rule_properties->custom_subject 	= $value['custom_subject'];
												$rule_properties->custom_content 	= $value['custom_content'];
																		...
																		<ul class="ls_email_rules_conditions">
																			...
																			<?php
																				...
																				foreach ($current_element_conditions as $value) {
																					...
																					$jquery_data_code .= "\$(\"#liemailrule_{$rule_id}_{$i}\").data('rule_condition',{\"target_rule_id\": \"{$rule_id}\",\"element_name\":\"{$condition_element_name}\",\"condition\":\"{$rule_condition}\",\"keyword\": \"{$rule_keyword}\"});\n";
