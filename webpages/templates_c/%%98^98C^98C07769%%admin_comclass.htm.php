<?php /* Smarty version 2.6.26, created on 2014-09-11 09:15:00
         compiled from admin/admin_comclass.htm */ ?>
...
" size="20" disabled/></td>    
		<td class="ud"><A href="index.php?m=comclass&c=up&id=<?php echo $this->_tpl_vars['v']['id']; ?>
">分类管理</A> | <A
			href="javascript:void(0)" onClick="layer_del('确定要删除？', 'index.php?m=comclass&c=del&delid=<?php echo $this->_tpl_vars['v']['id']; ?>
...
" name='del[]' onclick='unselectall()' rel="del_chk" /></td>
		...
		<td align="left">一级分类：<span onClick="checkname('<?php echo $this->_tpl_vars['class1']['id']; ?>
...
');"></td>
        <td class="ud"></td>
		<td class="ud" width="180"><A href="javascript:void(0)" onClick="layer_del('确定要删除？', 'index.php?m=comclass&c=del&delid=<?php echo $this->_tpl_vars['class1']['id']; ?>
');"class="admin_cz_sc">删除</A></td>
	</tr>
...
');"></td>
		<td class="ud"><A href="javascript:void(0)" onClick="layer_del('确定要删除？', 'index.php?m=comclass&c=del&delid=<?php echo $this->_tpl_vars['v']['id']; ?>
');"class="admin_cz_sc">删除</A></td>
	</tr>
	<?php endforeach; endif; unset($_from); ?>
	<?php endif; ?>
